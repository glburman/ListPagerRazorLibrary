...
namespace ListPagerExamples.Models
{
    public class AppDbContext : DbContext
    {
        ...
        public void LoadData()
        {
            ...
            Add(new Blogger() { Id = "21", FirstName = "John", LastName = "Darringer" });
            Add(new Blogger() { Id = "22", FirstName = "Bob", LastName = "Billy" });
            Add(new Blogger() { Id = "23", FirstName = "Sam", LastName = "Hill" });
            Add(new Blogger() { Id = "24", FirstName = "Skip", LastName = "Tracer" });
            Add(new Blogger() { Id = "25", FirstName = "Don", LastName = "Drysdale" });
            Add(new Blogger() { Id = "26", FirstName = "Robbie", LastName = "Alomar" });
            Add(new Blogger() { Id = "27", FirstName = "Rod", LastName = "Fish" });
            Add(new Blogger() { Id = "28", FirstName = "Strong", LastName = "Bow" });
            Add(new Blogger() { Id = "29", FirstName = "Tim", LastName = "Tom" });
            Add(new Blogger() { Id = "210", FirstName = "Lilly", LastName = "Marlaine" });
            Add(new Blogger() { Id = "211", FirstName = "Jane", LastName = "Goodall" });
            Add(new Blogger() { Id = "212", FirstName = "Janet", LastName = "Jackson" });
            Add(new Blogger() { Id = "213", FirstName = "Lucy", LastName = "Arnez" });
            Add(new Blogger() { Id = "214", FirstName = "Jelly", LastName = "Roll" });
            Add(new Blogger() { Id = "215", FirstName = "Lilly", LastName = "Tomlin" });
            Add(new Blogger() { Id = "216", FirstName = "Bo", LastName = "Jangles" });
            Add(new Blogger() { Id = "217", FirstName = "Molly", LastName = "Brown" });
            Add(new Blogger() { Id = "218", FirstName = "Princess", LastName = "Di" });
            Add(new Blogger() { Id = "219", FirstName = "Dolly", LastName = "Parton" });
            Add(new Blogger() { Id = "220", FirstName = "Rank", LastName = "Amateur" });
            Add(new Blogger() { Id = "2101", FirstName = "Frank", LastName = "James" });
            Add(new Blogger() { Id = "2102", FirstName = "Ace", LastName = "Ventura" });
            Add(new Blogger() { Id = "2103", FirstName = "Actual", LastName = "Hill" });
            Add(new Blogger() { Id = "2104", FirstName = "Fred", LastName = "Flintstone" });
            Add(new Blogger() { Id = "2105", FirstName = "Lolly", LastName = "Pop" });
            Add(new Blogger() { Id = "2106", FirstName = "Too", LastName = "Much" });
            Add(new Blogger() { Id = "2107", FirstName = "Itsa", LastName = "Laff" });
            Add(new Blogger() { Id = "2108", FirstName = "Bubble", LastName = "Gumby" });
            Add(new Blogger() { Id = "2109", FirstName = "Ricky", LastName = "Racer" });
            Add(new Blogger() { Id = "21010", FirstName = "Block", LastName = "Hed" });
            Add(new Blogger() { Id = "21011", FirstName = "John", LastName = "John" });
            Add(new Blogger() { Id = "21012", FirstName = "Suzy", LastName = "Queue" });
            Add(new Blogger() { Id = "21013", FirstName = "Lame", LastName = "Duque" });
            Add(new Blogger() { Id = "21014", FirstName = "Strict", LastName = "Mode" });
            Add(new Blogger() { Id = "21015", FirstName = "Depeche", LastName = "Mode" });
            Add(new Blogger() { Id = "21016", FirstName = "Rowen", LastName = "Boat" });
            Add(new Blogger() { Id = "21017", FirstName = "Sin", LastName = "Sitti" });
            Add(new Blogger() { Id = "21018", FirstName = "Data", LastName = "" });
            Add(new Blogger() { Id = "21019", FirstName = "William", LastName = "Shatner" });
            Add(new Blogger() { Id = "21020", FirstName = "Dr.", LastName = "Spock" });
