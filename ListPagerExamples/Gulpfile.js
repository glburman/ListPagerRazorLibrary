...
gulp.task('pager', function () {
    return gulp.src([
        'wwwroot/scss/pager/pager-theme-default.scss',
        'wwwroot/scss/pager/pager.scss'])
        .pipe(sass())
...
gulp.task('pager-dark', function () {
    return gulp.src([
        'wwwroot/scss/pager/pager.scss',
        'wwwroot/scss/pager/pager-theme-dark.scss'])
        .pipe(sass())
...
gulp.task('pager-neon', function () {
    return gulp.src([
        'wwwroot/scss/pager/pager.scss',
        'wwwroot/scss/pager/pager-theme-neon.scss'])
        .pipe(sass())
